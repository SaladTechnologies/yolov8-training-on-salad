...
def get_annotations(path, current_image_name, width, height):
    ...
    return {
        "bboxes": bboxes,
        "filename": str(current_image_name + ".jpg"),
...
def main():
    ...
    parser.add_argument(
        "--dataset",
        default=os.environ.get("DATASET", "flickr27"),
        type=str,
        help="flickr27 or logodet3k",
    )
    parser.add_argument(
        "--plot",
        default=os.environ.get("PLOT", False),
        type=bool,
        help="To plot converted bboxes",
    )
    parser.add_argument(
        "--image",
        default=".data/flickr_logos_27_dataset/flickr_logos_27_dataset_images/4771736332.txt",
        type=str,
        help="path to plot image",
    )
    args = parser.parse_args()

    if args.dataset == "flickr27":
        ...
        image_paths = get_image_paths(
            ".data/flickr_logos_27_dataset/flickr_logos_27_dataset_images"
        )
